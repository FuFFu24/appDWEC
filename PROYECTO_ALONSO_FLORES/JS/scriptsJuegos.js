document.addEventListener("DOMContentLoaded", function () {
  ...
  function mostrarJuegosMesa(lista) {
    ...
    destacados.innerHTML = `
      ...
      <p class="filtrar-ordenar">
          ...
          <select name="filtrar-ordenar" id="filtrar-ordenar">
              <option value="masVendidos" selected="selected">Más Vendidos</option>
  ...
  function ordenarMasVendidos(lista) {
    // Puedes asumir que "masVendidos" se basa en "nota", ordena de mayor a menor nota.
  ...
  function ordenarNuevo(lista) {
    // Puedes asumir que "nuevo" se basa en "fecha", ordena de más nuevo a más antiguo.
